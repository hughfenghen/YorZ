...
- [7. GUI 功能介绍](#7-gui-功能介绍)
  - [7.1 项目配置默认 Agent 方法](#71-项目配置默认-agent-方法)
  - [7.2 新建 spec](#72-新建-spec)
  - [7.3 新开项目并行](#73-新开项目并行)
  - [7.4 追加任务](#74-追加任务)
  - [7.5 Debug 模式](#75-debug-模式)
  - [7.6 内容批注](#76-内容批注)
  - [7.7 plan 决策待确认项](#77-plan-决策待确认项)
  - [7.8 Review 功能](#78-review-功能)
- [8. 常见工作流](#8-常见工作流)
