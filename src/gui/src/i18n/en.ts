export const en = {
  ...
  git: {
    ...
    mergeBranchPlaceholder: 'Pick a branch to merge',
    mergeFilterPlaceholder: 'Filter local / remote branches…',
    mergeAction: 'Merge',
    merging: 'Merging…',
    merged: 'Merged {{branch}} into {{current}}',
    mergeUpToDate: '{{current}} already contains {{branch}}',
    mergeSelfHint: 'The current branch cannot be merged into itself',
    push: 'Push',
    pushing: 'Pushing…',
