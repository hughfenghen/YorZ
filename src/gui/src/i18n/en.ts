export const en = {
  ...
  welcome: {
    ...
    description: 'YorZ hosts spec documents in local directories. Add a project directory first, then start managing its requirements.',
  ...
  newSpec: {
    title: 'New Spec',
    description: 'Just pick a type and enter your requirements. Filename, summary, and initial skeleton are generated by Agent based on your input. After document creation, it enters the plan stage automatically.',
    type: 'Type',
    typeFeat: 'feat',
    ...
    parallelWorktreeDesc: 'Create a new branch via git worktree for parallel development. Merge via the "Merge to Main" button on the list page.',
    requirement: 'Requirement',
    requirementPlaceholder: 'Raw needs, pain points, expected outcomes, related docs/modules (use @ to reference)',
    attachments: 'Attachments',
    attachmentsHint: '{{count}}/{{max}}, max 5 MB per file; images support Cmd/Ctrl-V paste',
    importAttachment: 'Import',
    createAndStart: 'Create & Start Agent',
    creating: 'Agent creating…',
    creatingHint: 'Agent is creating spec document… Watch streaming output in the Agent panel at bottom-right. Auto-navigate when ready.',
