export const zhCN = {
  ...
  chat: {
    ...
    addSlashCommandDescription: '自定义指令在输入框中键入 `/` 即可使用，且在所有项目间共享。',
    editSlashCommandTitle: '编辑指令',
    editSlashCommandDescription: '修改自定义指令后，会同步更新所有项目中的斜杠候选项。',
    ...
    customSlashCommandPrefillHint: '选择该指令后回填到输入框，可继续编辑后再发送',
