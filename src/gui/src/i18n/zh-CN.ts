export const zhCN = {
  ...
  chat: {
    ...
    addSlashCommandOption: '新增指令',
    addSlashCommandOptionDescription: '创建一个自定义斜杠指令',
    addSlashCommandTitle: '新增指令',
    editSlashCommandTitle: '编辑指令',
    slashCommandNoMatch: '没有匹配的指令',
    deleteSlashCommandTitle: '删除指令',
    deleteSlashCommandConfirm: '确定删除自定义指令 /{{name}}？此操作不可撤销。',
    slashCommandScopeProject: '当前项目',
    slashCommandScopeGlobal: '全局',
    customSlashCommandScope: '保存位置',
    customSlashCommandScopeProjectHint:
      '项目指令仅在当前项目可用，同名指令项目优先，保存后不可切换',
    customSlashCommandScopeGlobalHint: '全局指令在所有项目可用，保存后不可切换',
    customSlashCommandName: '名称',
    customSlashCommandNamePlaceholder: 'git-commit',
    customSlashCommandDescription: '说明',
    customSlashCommandDescriptionPlaceholder: '提交当前会话相关的变更文件',
    customSlashCommandHiddenPrompt: '隐藏提示词',
    customSlashCommandHiddenPromptPlaceholder: '使用 git 提交当前会话相关的变更文件',
    customSlashCommandHiddenPromptHint: '发送时自动附加给 Agent，不会出现在输入框和聊天记录中',
    customSlashCommandPrefill: '预输入内容',
    customSlashCommandPrefillPlaceholder: '选择该指令后回填到输入框的内容',
    customSlashCommandPrefillHint:
      '选择该指令后回填到输入框，会自动带上 /指令名 前缀，可继续编辑后再发送',
    customSlashCommandNameRequired: '请输入指令名称',
    customSlashCommandNameInvalid: '名称只能包含字母、数字、下划线和连字符',
    customSlashCommandNoDescription: '自定义指令',
    editCustomSlashCommand: '编辑 {{name}}',
    deleteCustomSlashCommand: '删除 {{name}}',
    saveCustomSlashCommand: '保存',
  },
  home: {
    specList: 'Spec 列表',
    mainProject: '主项目：',
  ...
  git: {
    ...
    noBranches: '没有匹配的分支',
    mergeBranch: '合并分支',
    mergeBranchPlaceholder: '选择要合并的分支',
    mergeFilterPlaceholder: '过滤本地 / 远程分支…',
    mergeAction: '合并',
    merging: '合并中…',
    merged: '已将 {{branch}} 合并到 {{current}}',
    mergeUpToDate: '{{current}} 已包含 {{branch}}，无需合并',
    mergeSelfHint: '当前分支不能合并到自身',
    push: '推送',
    pushing: '推送中…',
    pushed: '已推送到远端（{{branch}}）',
    pull: '拉取',
    pulling: '拉取中…',
    pulled: '已拉取最新提交（{{branch}}）',
    upToDate: '已是最新，无需拉取',
    binaryFile: '二进制文件，无法展示差异',
    diffTruncated: '差异过大，已截断展示',
    diffEmpty: '该文件暂无可展示的差异',
    diffLoading: '差异加载中…',
  },
  agentLogs: {
    backToSpec: '← 返回 spec',
